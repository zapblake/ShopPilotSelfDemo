      ...
      <table width="560" cellpadding="0" cellspacing="0" style="background:#141414;border-radius:16px;border:1px solid rgba(255,255,255,0.08);overflow:hidden;">
        ...
        <tr>
          <td style="padding:32px 40px;">
            ...
            <table cellpadding="0" cellspacing="0" style="margin:28px 0;">
              <tr>
                <td style="background:#f97316;border-radius:10px;">
                  <a href="${previewUrl}" style="display:inline-block;padding:14px 28px;font-size:15px;font-weight:600;color:white;text-decoration:none;">
                    View Your Demo →
                  </a>
                </td>
              </tr>
            ...
            <a href="${bookUrl}" style="font-size:14px;color:#f97316;text-decoration:none;font-weight:500;">
              Book a 20-min call →
            </a>
          </td>
        </tr>
